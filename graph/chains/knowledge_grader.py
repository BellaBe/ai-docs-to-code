        ...
        self.grade_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    """
                    You are a grader assessing the relevance of a retrieved document to a user question. If the document 
                    contains semantic meaning related to the question, grade it as relevant. Provide a binary score 'yes' 
